...
class LevelUpEventHandler(AskUserEventHandler):
    ...
    def ev_mousebuttondown(self, event: tcod.event.MouseButtonDown) -> Optional[ActionOrHandler]:
        """
        Don't allow the player to click to exit the menu like they normally can. 
        """
        #TODO rework this to allow the user to click the options to select
        return None
...
class MainGameEventHandler(EventHandler):
    def ev_keydown(self, event: tcod.event.KeyDown) -> Optional[ActionOrHandler]:
        ...
        #to proceed downstairs requires holding shift and pressing period
        #TODO make it simpler
        if key in INTERACT_KEYS and modifier and (
...
class PopupMessage(BaseEventHandler):
    ...
    def on_render(self, console: tcod.console.Console)-> None:
        """render the parent and dim the results then print message on top"""
        self.parent.on_render(console)
        console.rgb["fg"] //= 8
        console.rgb["bg"] //= 8
